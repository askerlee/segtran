...
class UNet(nn.Module):
    def __init__(self, n_channels, num_classes, bilinear=True, use_polyformer=False, num_modes=4):
        ...
        if self.use_polyformer:
            self.polyformer = PolyformerLayer(feat_dim=64, num_modes=num_modes)
