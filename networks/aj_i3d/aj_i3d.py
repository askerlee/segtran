...
class Unit3D(nn.Module):
    ...
    def __init__(self, in_channels,
        ...
        if self._use_batch_norm:
            ...
            #self.bn = nn.BatchNorm3d(self._output_channels, eps=0.001, momentum=0.01, track_running_stats=False) #debug
...
class InceptionI3d(nn.Module):
    ...
    def __init__(self, num_classes=400, spatial_squeeze=True,
        ...
        if do_pool1:
            ...
            self.end_points[end_point] = nn.Identity()
    ...
    def extract_features(self, x):
        ...
        for end_point in self.VALID_ENDPOINTS:
            if end_point in self.end_points:
                ...
                feat_dict[end_point] = x
        pooled_feat = self.avg_pool(x)
        feat_dict['pooled'] = pooled_feat
        return feat_dict

class AJ_I3D:
    @classmethod
    def get(cls, args):
        model = InceptionI3d(args.nclass, in_channels=3, do_pool1=args.do_pool1)
