...
GlobalParams = collections.namedtuple('GlobalParams', [
    ...
    'stem_stride', 'ibn_layers'])

# Parameters for an individual model block. 
# 'ibn' is newly added to customize for the IBN layer
BlockArgs = collections.namedtuple('BlockArgs', [
    'num_repeat', 'kernel_size', 'stride', 'expand_ratio',
    'input_filters', 'output_filters', 'se_ratio', 'id_skip', 'ibn_scheme'])
...
# returned new_filters is very close to filters * multiplier.
...
def efficientnet(width_coefficient=None, depth_coefficient=None, image_size=None,
    ...
    # r: num_repeat, k: kernel_size, s: stride, e: expand_ratio, i: input_filters, o: output_filters
    # expand_ratio is used in MBConvBlock.
    blocks_args = [
...
def load_pretrained_weights(model, model_name, weights_path=None, load_fc=True, advprop=False, ignore_missing_keys=False):
